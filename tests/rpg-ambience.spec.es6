suite('RPG Ambience', () => {
	...
	suite('adventure', () => {
		suite('upgrade', () => {
			...
			// properties to all adventures in a modular way instead makes  the
			// tests more difficult to read, so we simply test upgrading  a
			// single large adventure containing most or all of the relevant
			// properties.
			test('general', () => {
				const before = {
					version: 4,
